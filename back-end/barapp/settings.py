...
SECRET_KEY = 'tk6j5$p=o3!-dhzlgq6#%*!=!rk8sy^%led=^9b_ca1hx2oo(8'
...
## blocks client-side JavaScript from accessing the CSRF and session cookies.
...
EMAIL_HOST_USER = 'bariq.dev@gmail.com'
EMAIL_HOST_PASSWORD = 'Dj-tavr123'
EMAIL_PORT = 587
EMAIL_USE_TLS = True